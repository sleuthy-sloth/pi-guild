...
Pi Guild is in early development (0.1.x). Only the latest release receives
security fixes.
...
**Agents run with full system permissions.** Pi Guild is not a sandbox. An
agent spawned by Pi Guild can read, write, and execute anything the host user
...
- Run Pi Guild in a workspace you have reviewed.
